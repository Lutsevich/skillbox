...
var CommentsApp = function (_React$Component) {
    _inherits(CommentsApp, _React$Component);

    function CommentsApp() {
        _classCallCheck(this, CommentsApp);

        var _this = _possibleConstructorReturn(this, (CommentsApp.__proto__ || Object.getPrototypeOf(CommentsApp)).call(this));
        ...
        if (localStorage.comments) {
            ...
            _this.state = {
                comments: [{ author: 'Valery', dateTime: 1516648073108, text: 'initial test comments' }, { author: 'Sergey', dateTime: 1516648075308, text: 'initial test comment2' }, { author: 'Alex', dateTime: 1516648079708, text: 'initial test comment3' }],
                newAuthor: '',
                newDateTime: '',
                newText: ''
            };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.comments.map(function (comment, i) {
                        return _react2.default.createElement(_commentItem2.default, {
                            key: i,
                            author: comment.author,
                            dateTime: comment.dateTime,
                            delComment: _this2.delComment.bind(_this2, i)
                        });
                    })
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement("input", { type: "text",
                            ...
                            onChange: function onChange(ev) {
                                _this2.setState({ newAuthor: ev.target.value });
                            }
                        })
                    ),
                    _react2.default.createElement("br", null),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement("textarea", { rows: "4", cols: "50",
                            onChange: function onChange(ev) {
                                _this2.setState({ newText: ev.target.value });
                            },
...
_reactDom2.default.render(_react2.default.createElement(CommentsApp, null), document.querySelector('#app'));
...
function normalTime(date) {
    ...
    return timeObject.dd + '.' + timeObject.mm + '.' + timeObject.yyyy + ' ' + timeObject.h + ':' + timeObject.m + ':' + timeObject.s;
}
